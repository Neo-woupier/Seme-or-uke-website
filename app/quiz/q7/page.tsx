...
const initialOptions = [
  ...
  {
    text: 'บ่นนิดหน่อย " ทำไมสั่งอันนี้อ่า " แต่สุดท้ายก็กิน อยู่ดี ( ￣ー￣)💨',
    points: 2,
  },
  { text: "กินเท่าที่กินได้ ที่เหลือก็ปล่อยไว้งั้นแหละ (눈_눈)", points: 3 },
  {
    text: "เรียกพนักงานมา แล้วสั่งเมนูที่ตัวเองอยากกินเพิ่มแยกต่างหาก (≖_≖ )",
    points: 4,
  },
  {
    text: 'โวยเลย "สั่งอะไรมาเนี่ย!" แล้วจัดการสั่งเซ็ตใหม่มาคุมโต๊ะเอง (ﾟДﾟ)',
    points: 5,
  },
];

export default function QuizContent7() {
  ...
  return (
    <main className="flex flex-col items-center justify-center flex-grow p-4 md:py-8 md:px-24 w-full">
      ...
      <h1 className="text-2xl md:text-3xl font-bold text-pink-700 bg-white/80 px-6 py-2 rounded-3xl mb-6 text-center shadow-sm w-full max-w-2xl leading-relaxed">
        7. ไปกินข้าวกับเพื่อน แต่เพื่อนดันสั่งแต่ "ของที่คุณไม่ชอบกิน"
        มาเต็มโต๊ะเลย?
      </h1>
