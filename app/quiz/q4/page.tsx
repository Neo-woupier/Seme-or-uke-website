...
const initialOptions = [
  ...
  {
    text: 'ตะโกนอุทานก่อนเลย " ว้ายย ! " แล้วรีบทักหาคนช่วย (╯°□°）╯',
    points: 2,
  },
  {
    text: "หาอะไรแก้เครียดก่อนดึงสติ แล้วค่อยกลับมาแก้ปัญหา( ˘ヘ˘ )",
    points: 3,
  },
  {
    text: "นิ่งๆ สูดหายใจลึกๆ แล้วค่อยๆ คิดหาวิธีแก้ไปทีละสเตป( •̀ - •́ ) ",
    points: 4,
  },
  ...
  return (
    <main className="flex flex-col items-center justify-center flex-grow p-4 md:py-8 md:px-24 w-full">
      ...
      <h1 className="text-2xl md:text-3xl font-bold text-pink-700 bg-white/80 px-6 py-2 rounded-3xl mb-6 text-center shadow-sm w-full max-w-2xl leading-relaxed">
        4. สมมติว่าตอนนี้ตกอยู่ในสถานการณ์ที่ "แย่และกะทันหัน"
        ปฏิกิริยาแรกของคุณคือ?
      </h1>
